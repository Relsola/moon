...
const imgBaseUrl = import.meta.env.VITE_APP_BASE_IMG_URL;
        ...
        <div class="hot_articles">
          <dl class="hot_recommend" id="topBooks1">
            <dt>
              <a
                ...
                v-if="topBooks1[0]"
                >{{ topBooks1[0].bookName }}</a
              >
            </dt>
            <dd>
              <a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[1].bookId)"
                v-if="topBooks1[1]"
                >{{ topBooks1[1].bookName }}</a
              ><a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[2].bookId)"
                v-if="topBooks1[2]"
                >{{ topBooks1[2].bookName }}</a
              >
            </dd>
            <dd>
              <a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[3].bookId)"
                v-if="topBooks1[3]"
                >{{ topBooks1[3].bookName }}</a
              ><a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[4].bookId)"
                v-if="topBooks1[4]"
                >{{ topBooks1[4].bookName }}</a
              >
            </dd>
          </dl>
          <dl class="hot_recommend" id="topBooks2">
            <dt>
              <a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[5].bookId)"
                v-if="topBooks1[5]"
                >{{ topBooks1[5].bookName }}</a
              >
            </dt>
            <dd>
              <a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[6].bookId)"
                v-if="topBooks1[6]"
                >{{ topBooks1[6].bookName }}</a
              ><a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[7].bookId)"
                v-if="topBooks1[7]"
                >{{ topBooks1[7].bookName }}</a
              >
            </dd>
            <dd>
              <a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[8].bookId)"
                v-if="topBooks1[8]"
                >{{ topBooks1[8].bookName }}</a
              ><a
                href="javascript:void(0)"
                @click="bookDetail(topBooks1[9].bookId)"
                v-if="topBooks1[9]"
                >{{ topBooks1[9].bookName }}</a
              >
            </dd>
          </dl>
